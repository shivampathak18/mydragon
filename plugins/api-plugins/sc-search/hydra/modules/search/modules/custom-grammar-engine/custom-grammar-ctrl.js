...
var _this = this;
_this.depStack = [];
var grammarLib = require('./custom-grammar-lib');

exports.main = function(parentNode,query){
	// Call Grammar Lib to build a flow execution stack
	// Construct Query based on this stack
	// Query ES
	// Return results
	// 
	var queryArrays = grammarLib.main(parentNode,query);
	return queryArrays;
